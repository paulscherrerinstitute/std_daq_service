...
def read_service_arguments(service_description):
    ...
    service_name = args.service_name or os.environ.get("SERVICE_NAME", uuid.uuid4())
    ...
    return service_name, config, args.redis_host
